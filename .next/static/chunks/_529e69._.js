(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_529e69._.js", {
...
"[project]/src/components/MilanTransitDashboard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, k: __turbopack_refresh__, m: module, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "MilanTransitDashboard": (()=>MilanTransitDashboard)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
...
function MilanTransitDashboard() {
    ...
    // Weather API
    const fetchWeatherData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MilanTransitDashboard.useCallback[fetchWeatherData]": async ()=>{
            try {
                const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=Milan,IT&units=metric&appid=${("TURBOPACK compile-time value", "a4d2d8b85633712f5caa4fc5ef58a37b")}`);
                ...
                setWeatherData({
                    "MilanTransitDashboard.useCallback[fetchWeatherData]": (prev)=>({
                            ...prev,
                            condition: 'Error loading weather'
                        })
                }["MilanTransitDashboard.useCallback[fetchWeatherData]"]);
            }
        }
    }["MilanTransitDashboard.useCallback[fetchWeatherData]"], []);
    // Air Quality API
    const fetchAirQuality = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MilanTransitDashboard.useCallback[fetchAirQuality]": async ()=>{
            try {
                const response = await fetch(`https://api.openweathermap.org/data/2.5/air_pollution?lat=45.4642&lon=9.1900&appid=${("TURBOPACK compile-time value", "a4d2d8b85633712f5caa4fc5ef58a37b")}`);
                const data = await response.json();
                ...
                setAirQuality({
                    "MilanTransitDashboard.useCallback[fetchAirQuality]": (prev)=>({
                            ...prev,
                            status: 'Error loading AQI'
                        })
                }["MilanTransitDashboard.useCallback[fetchAirQuality]"]);
            }
        }
    }["MilanTransitDashboard.useCallback[fetchAirQuality]"], []);
    ...
    const fetchMetroData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MilanTransitDashboard.useCallback[fetchMetroData]": async ()=>{
            try {
                ...
                const updatedLines = mockData.map({
                    "MilanTransitDashboard.useCallback[fetchMetroData].updatedLines": (line)=>({
                            line: line.id,
                ...
                }["MilanTransitDashboard.useCallback[fetchMetroData].updatedLines"]);
                setMetroLines(updatedLines);
            } catch (error) {
                console.error('Error fetching metro data:', error);
                setMetroLines({
                    "MilanTransitDashboard.useCallback[fetchMetroData]": (prev)=>prev.map({
                            "MilanTransitDashboard.useCallback[fetchMetroData]": (line)=>({
                                    ...line,
                                    status: 'Error loading status'
                                })
                        }["MilanTransitDashboard.useCallback[fetchMetroData]"])
                }["MilanTransitDashboard.useCallback[fetchMetroData]"]);
            }
        }
    }["MilanTransitDashboard.useCallback[fetchMetroData]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MilanTransitDashboard.useEffect": ()=>{
            // Initial fetch
            const fetchData = {
                "MilanTransitDashboard.useEffect.fetchData": async ()=>{
                    await Promise.all([
                        fetchWeatherData(),
                        fetchAirQuality(),
                        fetchMetroData()
            ...
            }["MilanTransitDashboard.useEffect.fetchData"];
            fetchData();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-gradient-to-r from-red-600 to-red-700 p-4 text-white shadow-lg",
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CloudRain, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                className: "text-3xl font-bold flex items-center text-gray-800",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Train, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: metroLines.map((line)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                        className: "overflow-hidden hover:shadow-lg transition-shadow duration-200",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: `${line.color} p-5 text-white`,
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: `px-3 py-1 rounded-full ${line.status === 'Normal' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`,
...
_s(MilanTransitDashboard, "o1/O0hlZX7Sh2wcTIiOFfHiGgok=");
...
//# sourceMappingURL=_529e69._.js.map